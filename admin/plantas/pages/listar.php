...
<body>
                ...
                <?php if ($resultado->num_rows > 0): ?>
                    ...
                    <?php while ($planta = $resultado->fetch_assoc()): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo BASE_URL_PAGES; ?>editar.php?id=<?php echo $planta['id']; ?>">Editar</a>
                                |
                                <a href="<?php echo BASE_URL_ACTIONS; ?>excluir.php?id=<?php echo $planta['id']?>;" onclick="return confirm('Tem certeza que deseja excluir ?')">Excluir</a>
                                |
                                <a href="<?php echo BASE_URL_PAGES; ?>comentar.php?id=<?php echo $planta['id']?>">Escrever</a>
                            </td>
                        </tr>
    ...
    <script>
        ...
        const BASE_URL_ACTIOS = "<?php echo BASE_URL_ACTIONS ?>"

        document.getElementById("busca").addEventListener("keyup", function() {

            let termo = this.value;

            fetch(BASE_URL_ACTIOS + "buscar.php?termo=" + termo)
